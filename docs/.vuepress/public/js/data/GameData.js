...
var shootGameDataList = [
 // {thumbUrl: host+"001/thumb/demo.png",previewUrl: host+"001/source/",downloadUrl: host+"001/download/before.zip",description:"旅游风格的H5网站 Game",type:co.GAME_T_FULL,author:"leach-chen",authorurl:"",repo:"blog",fromauthor:"admin",fromauthorurl:"",from:co.FROM_GITHUB,sold:true},
      {
        thumbUrl: host+"1/storeh5game1_1_t_20190303.jpg",
        previewUrl: host+"1/storeh5game1_1_p_flappy/",
        downloadUrl: host+"1/storeh5game1_1_d_flappy.zip",
        originalUrl:"",
      ...
      {
        thumbUrl: host+"2/storeh5game1_2_t_20190304.jpg",
        previewUrl: host+"2/storeh5game1_2_p_fruit/",
        downloadUrl: host+"2/storeh5game1_2_d_fruit.zip",
